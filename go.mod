...
replace (
	...
	gitlab.falabella.tech/fif/corp/banking-platforms/cross/go-libs/error-fif => gitlab.falabella.tech/fif/corp/banking-platforms/cross/go-libs/error-fif.git v1.0.1
	gitlab.falabella.tech/fif/corp/banking-platforms/cross/go-libs/gin-fif => gitlab.falabella.tech/fif/corp/banking-platforms/cross/go-libs/gin-fif.git v1.0.3
	gitlab.falabella.tech/fif/corp/banking-platforms/cross/go-libs/http-fif => gitlab.falabella.tech/fif/corp/banking-platforms/cross/go-libs/http-fif.git v1.0.0
	gitlab.falabella.tech/fif/corp/banking-platforms/cross/go-libs/logger-fif => gitlab.falabella.tech/fif/corp/banking-platforms/cross/go-libs/logger-fif.git v1.0.0
	gitlab.falabella.tech/fif/corp/banking-platforms/cross/go-libs/server-fif => gitlab.falabella.tech/fif/corp/banking-platforms/cross/go-libs/server-fif.git v1.0.0
)
